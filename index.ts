...
let numb1:number=6, numb2:number=9; // Use the modulus operator (%) to find the remainder.
...
let a1 = true,
  b2 = false,
  c3 = true; // Write expressions using these.
...
let fahrenheit: number = 68; //  change this to test different values
let celsius: number;
...
let number3: number = -5; // Change this to test different numbers
